...
public class BoardController {
    ...
    public ResponseEntity<ResponseDto> postComment(
        @RequestBody @Valid PostCommentRequestDto requestbody, @PathVariable("receptionNumber") int receptionNumber
    ) {
        ResponseEntity<ResponseDto> resopnse = boardService.postComment(requestbody, receptionNumber);
        return resopnse;
    }
