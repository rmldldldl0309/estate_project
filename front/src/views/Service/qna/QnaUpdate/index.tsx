...
export default function QnaUpdate() {
    ...
    const getBoardReponse = (result: GetBoardResponseDto | ResponseDto | null) => {
    ...
    useEffect(() => {
        ...
        getBoardRequest(receptionNumber, cookies.accessToken).then(getBoardReponse);
    }, [loginUserRole])
