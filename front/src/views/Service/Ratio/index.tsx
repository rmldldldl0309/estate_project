...
export default function Ratio() {
    ...
    //                  function                    //
    const getRatioDataReponse = (result: GetRatioDataResponseDto | ResponseDto | null) => {
        ...
        const {yearMonth, return40, return4060, return6085, return85, 
    ...
    const onSearchClickHandler = () => {
        ...
        getRatioDataRequest(selectLocal, cookies.accessToken).then(getRatioDataReponse);
    }
