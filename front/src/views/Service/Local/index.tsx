...
export default function Local() {
    ...
    //                  function                   //
    const getLocalDataReponse = (result: GetLocalDataResponseDto | ResponseDto | null) => {
        const message =
            !result ? '서버에 문제가 있습니다.' :
    ...
    const onSearchClickHandler = () => {
        ...
        getLocalDataRequest(selectLocal, cookies.accessToken).then(getLocalDataReponse);
    }
        ...
        <div id='local-wrapper'>
            ...
            <div className='local-card'>
                ...
                <div className='local-card-chart-box'>
                    <Line options={saleOptions} data={saleData} width={'1086px'} height={'238px'}/>
                </div>
            </div>
            }
            ...
            <div className='local-card'>
                ...
                <div className='local-card-chart-box'>
                    <Line options={leaseOptions} data={leaseData} width={'1086px'} height={'238px'}/>
                </div>
            </div>
            }
            ...
            <div className='local-card'>
                ...
                <div className='local-card-chart-box'>
                    <Line options={monthRentOptions} data={monthRentData} width={'1086px'} height={'238px'}/>
                </div>
            </div>
            }
        </div>
